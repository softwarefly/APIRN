  ...
  def main(args: Array[String]) {
    ...
    for (weight <- 0 to 100) {
      ...
      for (month <- 2 to 12) {
        ...
        val setC = recognitionResult.filter(_._2._2._1 == "Black").filter(_._2._2._3 <= weight.toDouble / 100.0)
        ...
        val setFP = recognitionResult.filter(x => x._2._1._1 == "White" && x._2._2._1 == "Black").filter(_._2._2._3 <= weight.toDouble / 100.0)
        ...
        // 平均误差的结果
        val setME = recognitionResult.filter(x => x._2._1._1 != x._2._2._1).filter(_._2._2._3 <= weight.toDouble / 100.0)
